        ...
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-16 mb-24">
            <div class="md:col-span-5">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="https://www.instagram.com/gujju_scholar?igsh=cWNkN2ZpemtoZGV1" target="_blank" class="w-12 h-12 bg-white rounded-2xl border border-zinc-100 flex items-center justify-center hover:bg-orange-50 hover:text-orange-500 transition-all cursor-pointer shadow-sm" aria-label="Instagram">
                    ...
                    <a href="https://youtube.com/@@gujjuscholar?si=pouUHpxP5_onh0Wo" target="_blank" class="w-12 h-12 bg-white rounded-2xl border border-zinc-100 flex items-center justify-center hover:bg-orange-50 hover:text-orange-500 transition-all cursor-pointer shadow-sm" aria-label="YouTube">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.emperorsmartsolutions.gujjuscholar&pcampaignid=web_share" target="_blank" class="w-12 h-12 bg-white rounded-2xl border border-zinc-100 flex items-center justify-center hover:bg-orange-50 hover:text-orange-500 transition-all cursor-pointer shadow-sm" aria-label="Play Store">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M3.609 1.814L13.792 12l-10.183 10.186C3.218 21.8 3 21.282 3 20.672V3.328c0-.61.218-1.128.609-1.514zM14.925 10.867l2.802-1.614a1.867 1.867 0 011.895 0l2.803 1.614c.731.42.731 1.107 0 1.527l-2.803 1.614a1.867 1.867 0 01-1.895 0l-2.802-1.614-2.223-2.22zM4.34 22.951c.365.21.782.26 1.189.15l8.614-4.965-3.003-3.003-6.8 7.818zM4.34 1.049L11.14 8.867l3.003-3.003L5.529 .899A1.78 1.78 0 004.34 1.049z"/></svg>
                    </a>
                </div>
            </div>
